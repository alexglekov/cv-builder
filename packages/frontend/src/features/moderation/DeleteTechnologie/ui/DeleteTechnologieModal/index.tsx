...
import styles from './DeleteTechnologieModal.module.scss'
...
export const DeleteTechnologieModal: React.FC<AddNewColleagueModalProps> = React.memo((props: AddNewColleagueModalProps) => {
